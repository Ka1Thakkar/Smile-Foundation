    ...
    return (
        <div className="min-h-[150vh] w-screen relative">
            ...
            <div className="w-full bg-transparent lg:absolute">
                ...
                <div className="bg-[#001612] flex flex-col justify-center lg:h-[66vh]">
                    <Mentors />
                </div>
                <div className="lg:h-[42vh] text-white flex flex-col px-10 lg:px-40 justify-center items-center lg:items-start lg:text-left text-center py-20 relative">
                    <div className="absolute top-0 h-full flex lg:hidden">
